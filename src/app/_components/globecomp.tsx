            ...
            <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
                ...
                >
                    <h2 className="text-center text-xl md:text-4xl font-bold text-black">
                        Trusted Teachers from Over 170 Countries
                    </h2>
                    <p className="text-center text-base md:text-lg font-normal text-neutral-700 max-w-md mt-2 mx-auto">
                        Connect with qualified teachers from around the world for personalized learning. Explore subjects, languages, and skills — all in one global platform.
                    </p>
